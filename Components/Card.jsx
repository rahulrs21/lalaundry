        ...
        <div className="flex justify-evenly items-start ">
          <div className="flex flex-col justify-center items-center">
            ...
            <motion.img
              ...
              className="rounded-full h-[40px] w-[40px]  md:h-[64px] md:w-[64px] lg:h-[80px] lg:w-[80px] p-1  text-blue-500 my-2 bg-blue-200 hover:bg-blue-300 cursor-pointer hover:text-white"
              alt=""
            />
          ...
          <div className="flex flex-col justify-center items-center ">
            ...
            >
              <IronIcon
                className="rounded-full h-10 w-10  md:h-20 md:w-20 p-1 text-blue-500 my-2 bg-blue-200 hover:bg-blue-300 cursor-pointer hover:text-white"
                alt=""
              />
            </motion.div>
            <h3 className="text-[10px] md:text-2xl font-normal uppercase text-center mx-2">
