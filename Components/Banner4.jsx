...
function Banner4() {
  return (
    <div className='h-[75vh] max-w-full mx-42 mt-16  mx-auto overflow-x-hidden scrollbar-hide'>
        ...
        <motion.div initial={{y: 100, opacity:0}} whileInView={{y:0, opacity:1}} transition={{duration: 1}} className='max-w-xl py-10 relative top-0 md:-top-72  md:left-64 bg-gray-100  rounded-lg mx-auto shadow-lg scrollbar-hide'>
