...
function Banner4() {
  return (
    <div className='h-[75vh] max-w-full mx-42 mt-16  mx-auto overflow-x-hidden scrollbar-hide px-4'>
        <div>
            ...
            <motion.img initial={{y: -200, opacity:0}} whileInView={{y:0, opacity:1}} transition={{duration: 1}}  src="/img/clothes-shop.jpg" className='rounded-lg h-64 w-96 md:w-[70rem] md:h-[33rem] object-cover mx-auto' alt="" />
            
        </div>


        <motion.div initial={{y: 100, opacity:0}} whileInView={{y:0, opacity:1}} transition={{duration: 1}} className='max-w-xl py-10 relative -top-10 md:-top-72  md:left-64 bg-gray-100  rounded-lg mx-auto shadow-lg scrollbar-hide'>
            <div className='flex flex-col justify-center items-start px-10 space-y-5'>
