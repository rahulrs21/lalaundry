...
function Post({post}: Props) {
    ...
    // Now Form knows only these types which are in <IFormInput>, means these are the required fields
  ...
  return (
    <>
    <Head>
        <title>La Laundry - {post.title}</title>
    ...
    <main>
              ...
              serializers = {
                {
                  ...
                  p: (props: any) => {
                    <p className='text-sm font-normal my-5' {...props} />
                  },
                  li: ({children}: any) => {
        ...
        {/* To run the function u need to run "react-hook" https://react-hook-form.com/get-started */}
        ...
        {submitted ? (
          <div className="flex flex-col p-10 my-10 bg-blue-500 text-white max-w-2xl mx-auto">
              ...
              <p>Once it has been approved, Your comment will appear below</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col p-5 my-10 max-w-2xl mx-auto mb-10'>
            ...
            <label className='block mb-5'>
              ...
              <input {...register("email", { required: true } )} className='shadow border rounded py-2 px-3 mt-1 block w-full outline-blue-500 form-input ' placeholder='Enter Email' type="email" />
            </label>

            <label className='block mb-5'>
              <span className='text-gray-700'>Comment</span>
              <textarea {...register("comment", {required: true} )} className='shadow border rounded py-2 px-3 form-textarea block w-full outline-blue-500' placeholder='Enter your comment' rows={8} />
            </label>
            ...
            <input className='shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded cursor-pointer' type="submit" value="Submit" />
          </form>
        ) }
